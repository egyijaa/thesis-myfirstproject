        ...
        <?php if($this->uri->uri_string() == 'page/alumni' && $this->session->userdata('akses')!='2' && $this->session->userdata('akses')!='3') : ?>
        <!-- ChartJS -->
        ...
        <!-- jQuery Mapael -->
        <?php if(uri_string() == 'page/alumni' || uri_string() == 'page/siswa' || (uri_string() == 'Broadcast/toBroadcast' && $this->session->userdata('akses')!='2' && $this->session->userdata('akses')!='3')) : ?>
