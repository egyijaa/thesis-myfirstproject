<head>
    <script>
        function searchFilter(page_num) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>Lowongan/ajaxPaginationData/' + page_num,
                data: {
                    'page': page_num,
                    'keywords': keywords
                },
                        ...
                        <div class="col-lg-12">
                            <div class="card belakang">
                                <div class="card-body">
                                    <div class="content">
                                        <div class="container-fluid">
                                            <div class="row" <?php if($this->session->userdata('akses')=='3'){echo 'hidden';}?>>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <img id="image_upload_preview"
                                                                    src="http://placehold.jp/300x400.png"
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <a href="<?php echo base_url() ?>Lowongan/toLowongan2"
                                                ...
                                                <div class="col-md-4 dikit">
                                                    <div class="card testDulu flex-md-row mb-4 box-shadow h-md-250 belakang">
                                                        <div class="card-body d-flex flex-column align-items-start">
                                                            ...
                                                            <div class="mb-1 text-muted judulnya text-sm">Posted on: <?php echo  date("d-M-Y",strtotime($row['published']));?></div>
            ...
            <div id="konfirmasiDel2" class="modal fade">
                <div class="modal-dialog modal-confirm">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" data-dismiss="modal">Tidak</button>
                            <form action="<?php echo base_url(); ?>Lowongan/HapusAll" method="POST">
        ...
        $('#detailModal').on('show.bs.modal', function (event) {
            ...
            if (telepon != '') {
                if (ses2 == '2') {
                    ...
                    var tel = document.createElement("a");
                    tel.id = 'baruTel';
                    tel.className = 'btn btn-block btn-success disabled btn-block';
                    tel.innerHTML = "<i class='fab fa-whatsapp'></i><span><b id='hubungi'></b></span>";
                    document.getElementById("telepon").appendChild(tel);
                    modal.find('.modal-body #hubungi').html(' Hubungi');
                } 
            ...
            if (ig != '') {
                if (ses2 == '2') {
                    ...
                    var igk = document.createElement("a");
                    igk.id = 'baruIg';
                    igk.className = 'btn btn-block btn-danger disabled btn-block';
                    igk.innerHTML = "<i class='fab fa-instagram'></i><b id='lihatIg'></b>";
                    document.getElementById("ig").appendChild(igk);
                    modal.find('.modal-body #lihatIg').html(' Lihat');
                }else {
            ...
            if (twitter != '') {
                if (ses2 == '2') {
                    ...
                    var twit = document.createElement("a");
                    twit.id = 'baruTwit';
                    twit.className = 'btn btn-block btn-info disabled btn-block';
                    twit.innerHTML =
                    "<i class='fab fa-twitter'></i><span><b id='lihatTwit'></b></span>";
                    document.getElementById("twitterId").appendChild(twit);
                    modal.find('.modal-body #lihatTwit').html(' Lihat');
