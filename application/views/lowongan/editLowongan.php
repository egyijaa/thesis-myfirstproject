        ...
        <div class="row">
                        ...
                        <div class="form-group" hidden>
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="nisPass" class="form-control" name="nisPass"
                                    value="<?php echo $row['id_lowongan_pekerjaan']; ?>" title="enter your password.">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="judul">JUDUL</label>
                            <input type="text" class="form-control" name="judul" id="judul" placeholder="Judul"
                                title="enter your first name if any." value="<?php echo $row['judul']; ?>">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-success d-inline">
                                                ...
                                                <input id="nomorHpnya" name="nomornya" type="text" class="form-control"
            ...
            <div id="dataBantuan" class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        <h4>Butuh bantuan?</h4>
                        <img src="<?php echo base_url(); ?>/assets/bootstrap/img/helpdesk.png" style="width: 100%">
                        <p>helpdesk: <a
...
<script>
    $(document).ready(function () {
        ...
        function updActive(id) {
            ...
            spinner.show();
            $.ajax({
                url: "<?php echo base_url() ?>Lowongan/updateActive", //enter the login controller URL here
                type: "POST",
                dataType: "json",
                data: {
                    active: u,
                ...
                success: function (data) {
                    ...
                    if (u == 0) {
                        ...
                        document.getElementById("kondisi").innerHTML =
                            "Lowongan Belum Dipublikasikan/Aktif";
                    }
                },
                error: function (data) {
                    spinner.hide();
