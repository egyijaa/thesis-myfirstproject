                                                ...
                                                <table id="dataBroadcast"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><p class=" bg-gradient-fuchsia"><?php $date = date("d-F-Y", strtotime($row['published'])); echo $date;?></p></td>
                                                            <td>
                                                            <?php if (!empty($row['expired'])) :?>
                                                                <p class="bg-gradient-cyan"><?php $date = date("d-F-Y H:i", strtotime($row['expired'])); echo $date;?></p>
                                                            <?php else : ?>
                                    ...
                                    <div id="dataTambah" class="col-lg-12">
                                        <div class="card">
                                            <form id="form_lowongan" class="form"
                                                action="<?php echo base_url() ?>index.php/Broadcast/Tambah"
                                                        ...
                                                        <div class="input-group">
                                                            <div class="custom-file">
                                                                ...
                                                                <input name="gambar" type="file" accept='image/*'
                                                                    id="inputFile" class="custom-file-input"
                                                                    id="exampleInputFile">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="card card-outline card-info">
                                                            ...
                                                            <div class="card-body pad" id="masuk2">
                                                                <div class="mb-3">
                                                                    <textarea name="konten" class="textarea"
                                                                        rows="3" placeholder="Konten"
                                                                        required></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="modal-dialog modal-confirm">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="<?php echo base_url(); ?>index.php/Broadcast/Hapus" method="POST">
...
<script>
        ...
        $(document).on('click', '#save', function (event) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire('Disimpan!', 'Broadcast telah disimpan dan dapat dilihat oleh Alumni', 'success');
...
<script>
        ...
        Swal.fire({
            ...
            icon: 'info',
            html:
                'Jika hanya menyampaikan informasi dan <strong>tidak ditentukan tanggal</strong> maka jangan diisi form tanggalnya',
            focusConfirm: false,
            confirmButtonText:
