          ...
          <table cellspacing="0" cellpadding="0" border="0" align="center"
            ...
            <tr style="border-collapse:collapse">
              <td cellpadding="0" cellspacing="0" border="0" style="padding:0;Margin:0;line-height:1px;min-width:600px"
                height="0"><img
                  src="https://kclfjr.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
      ...
      <tr style="border-collapse:collapse">
        <td valign="top" style="padding:0;Margin:0">
          <table class="es-header" cellspacing="0" cellpadding="0" align="center"
            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:#28a745;background-repeat:repeat;background-position:center top">
            <tr style="border-collapse:collapse">
              <td align="center" style="padding:0;Margin:0">
                <table class="es-header-body" cellspacing="0" cellpadding="0" align="center"
                  ...
                  <tr style="border-collapse:collapse">
                    <td align="left"
                      style="Margin:0;padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:50px">
                    </td>
                  </tr>
                </table>
              </td>
          ...
          <table class="es-content" cellspacing="0" cellpadding="0" align="center"
            ...
            <tr style="border-collapse:collapse">
              <td style="padding:0;Margin:0;background-color:#28a745" bgcolor="#28a745" align="center">
                              ...
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                  ...
                                  <p
                                    ...
                                    Kami senang Anda sudah mendaftar dalam aplikasi alumni SMANTA Pontianak. <strong>Akun anda atas nama <strong style="color:#28a745 "><?php if (!empty($nama)){echo $nama;} else {echo 'Anonim';} ?></strong> sudah aktif</strong>, silahkan login dengan menekan tombol di bawah ini.</p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td align="center"
                                  ...
                                  <span class="es-button-border"
                                    style="border-style:solid;border-color:#28a745;background:1px;border-width:1px;display:inline-block;border-radius:2px;width:auto"><a
                                      href="<?php echo base_url().'index.php/login/toLogin'?>" class="es-button es-button-1 btn btn-primary" target="_blank"
                                      style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-width:15px 30px;display:inline-block;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center">
                                      LOGIN</a></span></td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#ff9800;font-size:18px">
                                    Jika terjadi kesalahan dalam melakukan login dapat menekan tombol dibawah ini :</p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" align="left"
                                  style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px"><a
                                    target="_blank" href="<?php echo base_url().'index.php/page/updateActiveSelf/'.$username; ?>"
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#f44336;font-size:18px">REACTIVATE (hanya berlaku selama 1 jam dari diterima email ini)</a></td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <p
                                    ...
                                    Cheers,</p>
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#28a745;font-size:18px">
                                    Admin Smanta Pontianak</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                        ...
                        <tr style="border-collapse:collapse">
                          <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                            <table
                              ...
                              <tr style="border-collapse:collapse">
                                <td esdev-links-color="#28a745" align="center"
                                  style="padding:0;Margin:0;padding-bottom:30px;padding-left:30px;padding-right:30px"><a
                                    ...
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#28a745;font-size:18px">We’re
                              ...
                              <tr style="border-collapse:collapse">
                                <td align="left" style="padding:0;Margin:0;padding-top:25px">
                                  <p
                                    ...
                                    Anda mendapatkan email ini karena admin sudah meng-aktifkan akun anda.
                                  </p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td align="left" style="padding:0;Margin:0;padding-top:25px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#666666;font-size:14px">
                                    Jalan WR Supratman, Benua Melayu Darat, Kec. Pontianak Sel., Kota Pontianak, Kalimantan Barat 78243</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                                ...
                                <td class="es-infoblock made_with" align="center"
                                  style="padding:0;Margin:0;line-height:120%;font-size:0;color:#CCCCCC"><a
                                    ...
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px"><img
                                      src="<?php echo base_url(); ?>/assets/image/gambar_web/logoSmanta.png"
                                      alt width="125"
