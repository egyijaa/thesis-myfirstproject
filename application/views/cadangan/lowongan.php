...
<script>
        function searchFilter(page_num) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>index.php/Lowongan/ajaxPaginationData2/' + page_num,
                data: {
                    'page': page_num,
                    'keywords': keywords
                },
...
<div class="bg1"></div>
    ...
    <div class="loading2">
        <img id="loading-image" class ="loading-image" src="<?php echo base_url() . 'assets/image/tenor.gif?t='.time() ?>" alt="Loading..." />
    </div>
    <div class="wrapper">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                ...
                                                <input style=" display:none;" id="keywords2" name="cari" type="text"
                                                    ...
                                                    placeholder="Cari Judul Lowongan Pekerjaan"
                                        ...
                                        <?php if($this->session->userdata('akses') == 2): ?>
                                            <div class="row">
                                                <div class="col-md-12 mb-2"> 
                                                    <a href="<?php echo base_url() ?>index.php/Lowongan/toLowongan" class="btn btn-dark float-right zoomPilih">Semua Postingan Lowongan Pekerjaan</a>
                                                </div>
                                            </div>
                                        <?php else:?>
                                            <div class="row">
                                                <div class="col-md-12 mb-2">
                                                    <button id="filterAngkatan_item" 
                                                        class="btn btn-dark float-right zoomPilih" onclick="filterAngkatan()"
                                                        value="<?php echo $this->session->userdata('ses_id');?>">Postingan Saya
                                                    </button>
                                                    <button id="filterAngkatan_item_off" style="display: none;"
                                                        class="btn btn-dark float-right zoomPilih" onclick="searchFilter()">Tampilkan Semua
                                                    </button>
                                                </div>
                                            </div>
                                        <?php endif;?>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <?php if ($this->session->userdata('akses')!='2' || $this->session->userdata('ses_id') == $row['username']){
                                                                                echo '<form
                                                                                        ...
                                                                                        echo '<form
                                                                                            action="'.base_url(); ?><?php echo 'index.php/Broadcast/kirimEmail"
                                                                                            method="POST" enctype="multipart/form-data">
                                                                                            <button name="cekEmail" value="'.$row['id_lowongan_pekerjaan'].'"
                                                                                                class="btn btn-dark zoomPilih" ><i
                                                                                                    class="fas fa-edit" ></i></button>
                                                                                        </form>';
                                                                        }?>
                                                            </div>
...
$(document).ready(function () {
    $('#detailModal').on('show.bs.modal', function (event) {
        ...
        modal.find('.modal-body #profilDetail').attr('src', "<?php echo base_url(); ?>/assets/image/lowongan/" + button.data('gambar'));
        ...
        function timer() {
            ...
            modal.find('.modal-body #siniTampil').html('<i class="fas fa-history"></i> '+ days + " Hari " + hours + " Jam " + minutes + " Menit " + remainingSeconds + " Detik");
            if (days < 3) {
                modal.find('.modal-body #siniTampil').attr('class', 'btn btn-block waktu2');
                modal.find('.modal-body #siniTampil').html('<i class="fas fa-exclamation-triangle"></i> '+ days + " Hari " + hours + " Jam " + minutes + " Menit " + remainingSeconds + " Detik <i class='fas fa-exclamation-triangle'></i>");
                if (days <= 0) {
                    modal.find('.modal-body #siniTampil').html('<i class="fas fa-exclamation-triangle"></i> ' + hours + " Jam " + minutes + " Menit " + remainingSeconds + " Detik <i class='fas fa-exclamation-triangle'></i>");
                    if (hours <= 0) {
                        modal.find('.modal-body #siniTampil').html('<i class="fas fa-exclamation-triangle"></i> ' + minutes + " Menit " + remainingSeconds + " Detik <i class='fas fa-exclamation-triangle'></i>");
                        if (minutes <= 0) {
                            modal.find('.modal-body #siniTampil').html('<i class="fas fa-exclamation-triangle"></i> ' + remainingSeconds + " Detik <i class='fas fa-exclamation-triangle'></i>");
                        }
                    }
                }
            }
            if (seconds <= 0) {
                ...
                modal.find('.modal-body #siniTampil').html("<i class='fab fa-expeditedssl'></i> Expired <i class='fab fa-expeditedssl'></i>");
            } else {
                seconds--;
            }
        }
        ...
        if (telepon != '') {
            if (ses2 == '2') {
                ...
                tel.id = 'baruTel';
                tel.href = 'https://api.whatsapp.com/send?phone=62' + wa + '&text=Mohon Maaf, Izin bertanya apakah lowongan pekerjaan yang dipublikasikan di aplikasi alumni smanta masih tersedia? terima kasih';
                tel.target = '_blank';
            ...
            if (ses2 == '2') {
                ...
                document.getElementById("telepon").appendChild(tel);
                modal.find('.modal-body #baruTel').html('<i class="fab fa-whatsapp"></i> Tidak Ada');
            } else {
                var tel = document.createElement("p");
                tel.id = 'baruTel';
                document.getElementById("telepon").appendChild(tel);
        ...
        if (ig != '') {
            ...
            if (ses2 == '2') {
                ...
                document.getElementById("ig").appendChild(igk);
                modal.find('.modal-body #baruIg').html('<i class="fab fa-instagram"></i> Tidak Ada');
            } else {
                var igk = document.createElement("p");
                igk.id = 'baruIg';
                document.getElementById("ig").appendChild(igk);
        ...
        if (twitter != '') {
            if (ses2 == '2') {
                ...
                twit.innerHTML = "<i class='fab fa-twitter'></i><span><b id='lihatTwit'></b></span>";
            ...
            if (ses2 == '2') {
                ...
                document.getElementById("twitterId").appendChild(twit);
                modal.find('.modal-body #baruTwit').html('<i class="fab fa-twitter"></i> Tidak Ada');
            } else {
                var twit = document.createElement("p");
                twit.id = 'baruTwit';
                document.getElementById("twitterId").appendChild(twit);
