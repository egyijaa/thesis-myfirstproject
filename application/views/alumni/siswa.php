        ...
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <h1 class="m-0 text-dark">Daftar Calon Alumni/Siswa Aktif SMA Negeri 3 Pontianak</h1>
                    <?php else : ?>
            ...
            <div class="card-body pb-0">
                <div class="row d-flex align-items-stretch">
                    <div class="col-12 col-sm-12 col-md-5 align-items-stretch">
                        ...
                        <div class="row">
                            <label for="enableTahun" class="col-12 text-center ">Ubah Username bagi akun Siswa</label>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" title="Detail" data-toggle="modal"
                                                        name="tombolNich" data-target="#detailModal" name="detil"
...
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="ubahPassword" name="ubahPassword" action="<?php echo base_url(); ?>Page/ubahPasswordAdmin"
                method="POST">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <?php endif; ?>
                                <div class="text-center">
                                    <form action="<?php echo base_url(); ?>page/toProfilebyOther" method="POST">
...
<script>
    $('#checkTahun').click(function (e) {
        ...
        var title = 'Enable ?';
        var html =
            'Apakah anda ingin akun siswa <span class="badge badge-danger">dapat mengubah</span> username-nya?';
        if (checkBox == 1) {
            title = 'Disable ?'
            html =
                'Apakah anda ingin akun siswa <span class="badge badge-info">tidak dapat mengubah</span> username-nya?';
        }
        Swal.fire({
            title: title,
            html: html,
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (u == 1) {
                            Swal.fire(
                                'Ubah Username Enabled',
                                'Akun siswa dapat melakukan perubahan pada username-nya',
                                'info'
                            )
                        }
                        if (u == 0) {
                            Swal.fire(
                                'Ubah Username Disabled',
                                'Akun siswa tidak dapat melakukan perubahan pada username-nya',
                                'info'
                            )
                        }
                    },
    ...
    $('input[name="cobaye"]').click(function (e) {
        ...
        var html =
            'Akun akan diaktifkan dan akan <p class="badge badge-success">dapat mengakses</p> sistem aplikasi';
        if (a == 1) {
            title = 'Non-aktifkan Akun?';
            html =
                'Akun akan dinon-aktifkan dan <p class="badge badge-danger">tidak dapat mengakses</p> sistem aplikasi';
        }
        Swal.fire({
            title: title,
            html: html,
    ...
    $('input[name="cobaye2"]').click(function (e) {
        var b = $('#checkTahun').val();
        var id = $(this).data('id');
        var a = $(this).data('roles');
        var title = 'Ubah Roles jadi Alumni?';
        var html = 'Akun dengan username: <p class="badge badge-info">' + id +
            '</p> akan diubah roles menjadi <p class="badge badge-success">ALUMNI</p>';
        if (a == 'alumni') {
            title = 'Ubah Roles jadi Siswa?';
            html = 'Akun dengan username: <p class="badge badge-info">' + id +
                '</p> akan diubah roles menjadi <p class="badge badge-danger">SISWA</p>';
        }
        Swal.fire({
            title: title,
            html: html,
...
<script>
    $(document).ready(function () {
        $('input').focus(function () {
            if ($("#masuk4").is(":hidden")) {
                $("#masuk4").attr('hidden', false);
            }
        })
        $('input').focusout(function () {
            if (!$("#masuk4").is(":hidden")) {
                $("#masuk4").attr('hidden', true);
            }
        })
        ...
        $('#detailModal').on('show.bs.modal', function (event) {
            ...
            modal.find('.modal-body #profilDetail').attr('src',
                "<?php echo base_url(); ?>/assets/image/foto_profil/" + button.data(
                    'foto_profil'));
        ...
        $('#konfirmasiDel').on('show.bs.modal', function (event) {
            ...
            Swal.fire({
                ...
                icon: 'info',
                html: 'Jika akun user ini dihapus maka segala hal yang berkaitan dengan akun tersebut juga terhapus<br><br>' +
